    ...
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">{{__('custom.programSetup')}}</div>
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{route('fullcalender.id','all')}}"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">{{__('custom.programSetup')}}
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <form class="row g-3" method="POST" action="{{ $route }}">
                                    ...
                                    <div class="col-md-6">
                                        <label for="name"
                                               class="form-label">{{__('custom.program')}} {{__('custom.name')}}
                                            *</label>
                                    ...
                                    <div class="col-md-4">
                                        <label for="category" class="form-label">{{__('custom.category')}} *</label>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="sort" class="form-control" id="sort"
                                               ...
                                               placeholder="{{__('enter')}} Øvelsesnummer" required>
                                        @error('sort')
                                        <strong>{{ $message }}</strong>
                                        @enderror
                                    </div>
