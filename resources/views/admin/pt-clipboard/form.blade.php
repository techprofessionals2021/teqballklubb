                        ...
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__('custom.group')}} / {{!$edit ? __('custom.create') : __('custom.edit')}}</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="ms-auto">
                                    ...
                                    <div class="p-4 border rounded">
                                        <form class="row g-3" method="POST" action="{{ $route }}">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="name" class="form-control" id="name" value="{{ old('name',$group->name) }}" minlength="3" placeholder="Enter Name" required>
                                                @error('name')
