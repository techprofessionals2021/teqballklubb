                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{__('custom.intensity')}}
                        ...
                        <div class="card-body">
                            <div class="p-4 border rounded">
                                <form class="row g-3" method="POST" action="{{ $route }}">
                                    ...
                                    <div class="col-md-12">
                                        <label for="name"
                                               class="form-label">{{__('custom.intensity')}} {{__('custom.name')}}
                                            *</label>
                                        <input type="text" name="name" class="form-control" id="name"
                                               value="{{ old('name',$intensity->name) }}" minlength="3"
