					...
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">{{__('custom.roleList')}}</li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
						<div class="btn-group">
							<a href="{{route('role.create')}}" class="btn btn-primary">{{__('custom.addRole')}}</a>
						</div>
					</div>
				</div>
				<!--end breadcrumb-->
...
{{--                                        <td>{{date('d-M-Y' , strtotime($item->created_at))}}</td>--}}
                                        <td>
                                            <a href="{{route('role.edit',['role' => $item->id ])}}" class="btn btn-info text-white">{{__('custom.edit')}}</a>

                                            <a href="{{route('role.permission',['id' => $item->id ])}}" class="btn btn-primary text-white">{{__('custom.permission')}}</a>
